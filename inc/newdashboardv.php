   ...
   <div class="dc">
      ...
      <div class="dr">
         <div class="drinr">
                           ...
                           <div class="width90">
                              <div onclick=" $('#dall').dialog('open');refreshdbdata();fnloadgrid('');"  title="Click me to view more vehicle information" class="col-sm-3 zoom">
                                 <div class="mini-stat clearfix bx-shadow bg-white he box1" style="border: 5px solid #317eeb;border-top:none;border-bottom:none;padding:3px 5px 4px 5px !important">
                                    <h3 class="text-uppercase text-right" style="margin: 10px;font-size: inherit;">
                                       <?php echo strtoupper($la['OBJECT']);?><span  id="spantotalvehicleper"  class="pull-right"></span>  <span  id="spantotalvehicle"  class="counter text-dark float-right">100</span>
                                    </h3>
                                 </div>
                              </div>
                              <div  onclick="dashboardOpenDallID('online');" class="col-sm-3" style="margin-left:0px;">
                                 <div class="mini-stat clearfix bx-shadow bg-white he box1" style="border: 5px solid #F5456D;border-top:none;border-bottom:none;padding:3px 5px 4px 5px !important">
                                    <h3 class="text-uppercase text-right" style="margin: 10px;font-size: inherit;"><?php echo strtoupper($la['ONLINE']);?><span class="float-right" id="spanonlinevehicle">0</span> </h3>
                                 </div>
                              </div>
                              <div onclick="dashboardOpenDallID('offline');" class="col-sm-3" style="margin-left:0px;">
                                 <div class="mini-stat clearfix bx-shadow bg-white he box1" style="border: 5px solid #99B958;border-top:none;border-bottom:none;padding:3px 5px 4px 5px !important">
                                    <h3 class="text-uppercase text-right" style="margin: 10px;font-size: inherit;"><?php echo strtoupper($la['NO_DATA']);?><span class="float-right" id="spanofflinevehicle">0</span> </h3>
                                 </div>
                              </div>
                              <!-- <div onclick="dashboardOpenDallID('nspeed');" class="col-sm-3" style="margin-left:0px">
                                 <div class="mini-stat clearfix bx-shadow bg-white he box1" style="border: 5px solid #5c589a;border-top:none;border-bottom:none;padding:3px 5px 4px 5px !important">
                                    <h3 class="text-uppercase text-right" style="margin: 10px;font-size: inherit;" ><?php echo strtoupper($la['NORMALSPEED']);?><span class="float-right" id="spannormalspeedvehicle">0</span></h3>
                                 </div>
                              </div> -->
                              <div onclick="dashboardOpenDallID('moffline');" class="col-sm-3" style="margin-left:0px">
                                 <div class="mini-stat clearfix bx-shadow bg-white he box1" style="border: 5px solid #5c589a;border-top:none;border-bottom:none;padding:3px 5px 4px 5px !important">
                                    <h3 class="text-uppercase text-right" style="margin: 10px;font-size: inherit;" ><?php echo strtoupper($la['IDLE_MAINTENANCE']);?><span class="float-right" id="spanmaintenancevehicle">0</span></h3>
                                 </div>
                              </div>
                              <div onclick="dashboardOpenDallID('ospeed');" class="col-sm-3" style="margin-left:0px">
                                 <div class="mini-stat clearfix bx-shadow bg-white he box1" style="border: 5px solid #388c98;border-top:none;border-bottom:none;padding:3px 5px 4px 5px !important">
                                    <h3 class="text-uppercase text-right" style="margin: 10px;font-size: inherit;" ><?php echo strtoupper($la['OVERSPEED']);?><span class="float-right" id="spanoverspeedvehicle">0</span></h3>
                                 </div>
                              </div>
                              <div class="col-sm-3" style="margin-left:0px" onclick="dashboardOpenDallID('service');">
                                 <div class="mini-stat clearfix bx-shadow bg-white he box1" style="border: 5px solid #d84242;border-top:none;border-bottom:none;padding:3px 5px 4px 5px !important">
                                    <h3 class="text-uppercase text-right" style="margin: 10px;font-size: inherit;" ><? echo strtoupper($la['SERVICE']); ?><span class="float-right"></span> </h3>
                                 </div>
                              </div>
                              <div class="col-sm-3" style="margin-left:0px" onclick="refreshdbdata()">
                                 <div class="mini-stat clearfix bx-shadow bg-white he box1" style="border: 5px solid #589a5f;border-top:none;border-bottom:none;padding:3px 5px 4px 5px !important">
                                    <h3 class="text-uppercase text-right" style="margin: 10px;font-size: inherit;" ><? echo strtoupper($la['REFRESH']); ?><span class="float-right"><i class="fa fa-refresh" ></i></span> </h3>
                                 </div>
                              </div>
                           </div>
                        </div>
			...
			<div class="row2">
			<div class="width20">
                              <img src="theme/images/xls.svg" onclick="liveTripReportGenerate('xls')" width="30px" border="0" style="float: left;padding: 3px;" title="XLS">
                              <img src="theme/images/pdfdownload.png" onclick="liveTripReportGenerate('pdf')" width="30px" border="0" style="float: left;padding: 3px;" title="PDF">
                              <!-- <button onclick="openFullscreen();">Fullscreen</button> -->
			      <img src="theme/images/htmldownload.png" onclick="liveTripReportGenerate('html')" width="30px" border="0" style="float: left;padding: 3px;" title="HTML">     
			</div>
				...
				<div class="width5">
                           ...
                           <div class="width1"></div>
                            <div class="width5">
                                <select class="width100 textboxextra_style" id="dialog_dashb_hour_from">
                                    <? include ("inc/inc_dt.hours.php"); ?>
                                </select>
                            </div>
                            <div class="width1"></div>
                            <div class="width5">
                                <select class="width100 textboxextra_style" id="dialog_dashb_minute_from">
			 ...
			 <div class="width2"></div>
				<div class="width5">
                            ...
                            <div class="width1"></div>
                            <div class="width5">
                                <select class="width100 textboxextra_style" id="dialog_dashb_hour_to">
                                    <? include ("inc/inc_dt.hours.php"); ?>
                                </select>
                            </div>
                            <div class="width1"></div>
                            <div class="width5">
                                <select class="width100 textboxextra_style" id="dialog_dashb_minute_to">
                                    <? include ("inc/inc_dt.minutes.php"); ?>
                                </select>
                            </div>
				<div class="width1"></div>
                            ...
                            <div class="width20">
                              <select style="border-radius: 18px;border-color: #deaaaa!important;padding-left: 9px !important;" id="dashboard_object_group_list" onchange="changeGroupwiseDashboadr()"></select>
                              <input type="text" placeholder="Search Object" id="dashboard_live_trip_searchobject" style="border-radius: 18px;border-color: #deaaaa!important;padding-left: 9px !important;margin-left: 0%;">
			      </div>
				
			       <div class="width1"></div>
				<div class="width10"><input class="button textboxextra_style" type="button" onclick="dashboardLivetripKM();" value="<? echo $la['REFRESH']; ?>" /></div>
                              </div>
                              ...
                              <table id="dashboard_live_tripwisekm_report"></table>
                              <div id="dashboard_live_tripwisekm_report_grid_pager"></div>
                           </div>
                        </div>
                     </div>
                  </div>
