...
<div id="dialog_about" title="<? echo $la['ABOUT']; ?>">
	<div class="row">
		<center><img class="logo" src="<? echo $gsValues['URL_LOGO']; ?>" /></center>
	</div>
...
<!-- code update by vetrivel.NR -->
<div id="dialog_address_search_dispensor" title="<? echo $la['ADDRESS_SEARCH'];?>">
	<div class="row">
		<div class="row2">
			<div class="width100">
				<input class="inputbox" type='text' id='dialog_address_search_addr_dispensor' onkeydown="if (event.keyCode == 13) utilsSearchAddress();" maxlength="100"/>
			</div>
		</div>
	</div>
		
	<center>
	    <input class="button icon-search icon" type="button" onclick="utilsSearchAddressdispensor();" value="<? echo $la['SEARCH']; ?>" />&nbsp;&nbsp;&nbsp;
	    <input class="button icon-close icon" type="button" onclick="closedispensorpic();" value="<? echo $la['CANCEL']; ?>" />
	</center>
	<!-- code update by vetrivel.NR -->
	<br>
	<center>
		<input class="button" type="button" onclick="getmycuurentpic_dispen();" value="<? echo $la['GETMY_PICK']; ?>" />
	</center>
	
</div>

<div id="dialog_address_search_ambulance" title="<? echo $la['ADDRESS_SEARCH'];?>">
	<div class="row">
		<div class="row2">
			<div class="width100">
				<input class="inputbox" type='text' id='dialog_address_search_addr_ambulance' onkeydown="if (event.keyCode == 13) utilsSearchAddress();" maxlength="100"/>
			</div>
		</div>
	</div>
		
	<center>
	    <input class="button icon-search icon" type="button" onclick="utilsSearchAddressAmbulance();" value="<? echo $la['SEARCH']; ?>" />&nbsp;&nbsp;&nbsp;
	    <input class="button icon-close icon" type="button" onclick="closeambulancepic();" value="<? echo $la['CANCEL']; ?>" />
	</center>
	<!-- code update by vetrivel.NR -->
	<br>
	<center>
		<input class="button" type="button" onclick="getmycuurentpic();" value="<? echo $la['GETMY_PICK']; ?>" />
	</center>
...
<div id="dialog_billing_plan_use" title="">
	<div class="controls-block width100">
		...
		<div class="block width30">
			<input class="button icon-check icon float-right" type="button" onclick="billingPlanUseActivate();" value="<? echo $la['ACTIVATE']; ?>" />
		</div>
	</div>
