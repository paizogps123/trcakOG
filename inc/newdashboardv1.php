...
<div style="height:40%;">
<div class="">
   <marquee id="notify"  scrollamount="3" direction="left" behaviour="scroll" onMouseOver="this.stop();" onMouseOut="this.start();"><ol><a style="color:red;" target="_blank" >Notification Not Available</a></ol></marquee>
  </div>
  ...
  <div class="row">
    <div class=" width100">
      <div class="container">
       ...
       <div class="block width65" style="background: none">
      <div class="container ">
        <div class="">
            <div class="width100">
