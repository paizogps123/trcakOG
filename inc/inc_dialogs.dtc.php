<div id="dialog_dtc" title="<? echo $la['DIAGNOSTIC_TROUBLE_CODES']; ?>">
	<div class="controls-block width100">
		<input style="width: 100px;" class="button float-right" type="button" value="<? echo $la['SHOW']; ?>" onclick="dtcShow();"/>
		<input style="width: 100px; margin-right: 3px;" class="button float-right" type="button" value="<? echo $la['EXPORT_CSV']; ?>" onclick="dtcExportCSV();"/>
		<input style="width: 100px; margin-right: 3px;" class="button float-right" type="button" value="<? echo $la['DELETE_ALL']; ?>" onclick="dtcDeleteAll();"/>
	</div>
