...
<div id="dialog_places_marker_properties" title="<? echo $la['MARKER_PROPERTIES']; ?>">
	...
	<center>
		<input class="button icon-save icon" id="placesMarkerPropertiesSave" type="button" onclick="placesMarkerProperties('save');" value="<? echo $la['SAVE']; ?>" />&nbsp;
		<input class="button icon-close icon" id="placesMarkerPropertiesCancel" type="button" onclick="placesMarkerProperties('cancel');" value="<? echo $la['CANCEL']; ?>" />
	</center>
</div>
...
<div id="dialog_places_zone_properties" title="<? echo $la['ZONE_PROPERTIES']; ?>">
	...
	<center>
		<input class="button icon-save icon" id="placesZonePropertiesSave" type="button" onclick="placesZoneProperties('save');" value="<? echo $la['SAVE']; ?>" />&nbsp;
		<input class="button icon-close icon" id="placesZonePropertiesCancel" type="button" onclick="placesZoneProperties('cancel');" value="<? echo $la['CANCEL']; ?>" />
	</center>
</div>
...
<div id="dialog_places_route_properties" title="<? echo $la['ROUTE_PROPERTIES']; ?>">
	...
	<center>
		<input class="button icon-save icon" type="button" id="placesRoutePropertiesSave" onclick="placesRouteProperties('save');" value="<? echo $la['SAVE']; ?>" />&nbsp;
		<input class="button icon-close icon" type="button" id="placesRoutePropertiesCancel" onclick="placesRouteProperties('cancel');" value="<? echo $la['CANCEL']; ?>" />
	</center>
</div>