...
function initGui() {
    ...
    }), $("#dialog_address_search_cabbooking").dialog({
        autoOpen: !1,
        width: "250",
        height: "auto",
        minHeight: "auto",
    ...
    $("#dialog_image_gallery").dialog({
       ...
       open: function (event, ui) {
        $('#report_show_online').css('overflow-y', 'scroll');
      }
...
//end trip data.
  ...
  $("#boarding_hotspot_list_grid").jqGrid({
     ...
     datatype: "json",
     colNames: [la.DEPARTMENT,la.SECTION,la.ID_NUMBER,la.VNAME,la.GENDER,la.MOBILENO,"",la.EMAILID,la.MORNING_HOTSPOT,la.EVENING_HOTSPOT,la.STATUS,"","uid","route_id","section_id","dept_id","route_id_down","parent","rfid","zone_id","zone_id_down"],
     colModel: [
     {
         name: "dept_name",
         index: "dept_name",
...
function initSelectList(e) {
    switch (e) {
        ...
        case "gallery_object_list":
            ...
            sortSelectList(t), t.options.add(new Option(la.ALL_OBJECTS, ""), 0), t.value = "";
            break;
        case "setting_load_simcard":
            var t = document.getElementById("dialog_settings_object_edit_new_sim_number");
            t.options.length = 0;
            for (var key in settingsSimCardDetails)
            {
                var sim = settingsSimCardDetails[key];
                t.options.add(new Option(sim.number,sim.id));
            }
            sortSelectList(t),t.options.add(new Option('Select',''), 0),t.value = "";
            break;
...
function initGrids() {
    ...
    $("#dashboard_live_tripwisekm_report").jqGrid({
        ...
        datatype: "json",
        colNames: [la.NAME,la.TRIPNAME,la.START,la.END,la.STARTTIME,la.ENDTIME,la.AROUTE_START,la.AROUTE_END,la.UNIT_KM,la.FREEZED_KM,la.EMPTYKM,la.DURATION,la.STARTING_FUEL,la.ENDING_FUEL,la.FUEL_FILLINGS,la.FUEL_CONSUMPTION,la.KMPL,'Close'],
        colModel: [{
            name: "name",
            index: "name",
            width: 100
    ...
    }), $("#side_panel_objects_object_list_grid").setCaption('<div class="row4"><div class="width65"><input id="side_panel_objects_object_list_search" class="inputbox-search" type="text" value="" placeholder="' + la.SEARCH + '" maxlength="25"></div><div class="float-right"><a href="#" onclick="MapOnlineOfflineObject('+"\'online\'"+');"><div class="panel-button" id="maponlinecount" title="' + la.ONLINE + '" style="background-color: #12b30c8c!important;padding: 5px;padding-left: 8px;border-radius: 4px;padding-right: 8px;">0</div></a><a href="#" onclick="MapOnlineOfflineObject('+"\'offline\'"+');"><div class="panel-button" id="mapofflinecount" title="' + la.NO_DATA + '" style="background-color: #cc24248c!important;padding: 5px;padding-left: 8px;border-radius: 4px;padding-right: 8px;">0</div></a><a href="#" onclick="objectReloadData();"><div class="panel-button"  title="' + la.RELOAD + '"><img src="theme/images/refresh-color.svg" width="16px" border="0"/></div></a><a href="#" onclick="settingsObjectAdd(\'open\');"><div class="panel-button"  title="' + la.ADD_OBJECT + '"><img src="theme/images/object-add.svg" width="16px" border="0"/></div></a></div></div>'), $("#side_panel_objects_object_list_search").bind("keyup", function() {
...
function reportProperties(e) {
    switch (e) {
        ...
        case "generate":
                var c = document.getElementById("dialog_report_name").value;
                var g = document.getElementById("dialog_report_type").value,
                m = document.getElementById("dialog_report_format").value,
                of = document.getElementById("dialog_report_online_offline").checked,
                u = document.getElementById("dialog_report_show_coordinates").checked,
                p = document.getElementById("dialog_report_show_addresses").checked,
                v = document.getElementById("dialog_report_zones_addresses").checked;
                // p=false,
                ...
                var y = document.getElementById("dialog_report_stop_duration").value,
                E = document.getElementById("dialog_report_speed_limit").value,
                b = multiselectGetValues(document.getElementById("dialog_report_object_list")),
                h = multiselectGetValues(document.getElementById("dialog_report_zone_list")),
                hv = multiselectGetValues(document.getElementById("dialog_report_zone_list_second")),
	...
	return "overspeed" != e.type && "underspeed" != e.type && "rag" != e.type || "" != e.speed_limit ? "emergencyalert" != e.type && "stisgeneralreport" != e.type && "maintenancereport" != e.type  && "" == e.imei ? void notifyBox("error", la.ERROR, la.AT_LEAST_ONE_OBJECT_SELECTED) : ("zone_in_out" == e.type  || "roundtripreport" == e.type ) && "" == e.zone_ids ? void notifyBox("error", la.ERROR, la.AT_LEAST_ONE_ZONE_SELECTED) : "logic_sensors" != e.type && "sensor_graph" != e.type || "" != e.sensor_names ? (loadingData(!0), void $.ajax({
        ...
        success: function(t){
            ...
            if(e.onoff==true){
                ...
                var htmlDecode=Base64.decode(t);
                document.getElementById('online_report_show').innerHTML =htmlDecode;
                $(".cat1").css({"display":"table-row"});               
                $("#report_show_online").dialog("open");
            }else{
                $.generateFile({
...
function reportsSwitchType() {
    ...
    switch (t.options.length = 0, "speed_graph" != e && "altitude_graph" != e && "acc_graph" != e && "fuellevel_graph" != e && "temperature_graph" != e && "sensor_graph" != e ? (t.options.add(new Option("HTML", "html")), t.options.add(new Option("PDF", "pdf")), t.options.add(new Option("XLS", "xls"))) : t.options.add(new Option("HTML", "html")), e) {
        ...
        case "roundtripreport":
            ...
            break;
        case "ifsinfograph":
            document.getElementById("dialog_report_online_offline").disabled = !0,$("#dialog_report_online_offline").prop("checked", false);
            break;
        case "ifsinfograph_raw":
            document.getElementById("dialog_report_online_offline").disabled = !0,$("#dialog_report_online_offline").prop("checked", false);
            break;
        case "tempgraph":
            document.getElementById("dialog_report_online_offline").disabled = !0,$("#dialog_report_online_offline").prop("checked", false);
            break;
        default:
        	 document.getElementById("dialog_report_zone_list").disabled = !0,document.getElementById("dialog_report_zone_list_second").disabled = !0, $("#dialog_report_zone_list option:selected").removeAttr("selected"), document.getElementById("dialog_report_sensor_list").disabled = !0, $("#dialog_report_sensor_list option:selected").removeAttr("selected"), document.getElementById("dialog_report_speed_limit").disabled = !0, document.getElementById("dialog_report_stop_duration").disabled = !0, document.getElementById("dialog_report_show_coordinates").disabled = !1, document.getElementById("dialog_report_show_addresses").disabled = !1, document.getElementById("dialog_report_zones_addresses").disabled = !1,document.getElementById("dialog_report_online_offline").disabled = !1;
        	 break;
    }
}
...
function settingsEventProperties(e) {
    switch (e) {
        ...
        case "save":
            ...
            if ("stopped" == c || "moving" == c || "engidle" == c || "aconidle"==c ) {
                var v = document.getElementById("dialog_settings_event_time_period").value;
                if ("" == v) {
                    notifyBox("error", la.ERROR, la.ALL_AVAILABLE_FIELDS_SHOULD_BE_FILLED_OUT);
                    break
    ...
    switch (e) {
        ...
        case "object_groups":
            ...
            $.ajax({
                ...
                cache: !1,
                success: function(e) {
                    settingsObjectGroupData = e, settingsEditData.group_id = !1, initSelectList("object_group_list"), t(!0),dashboardloadGroup()
                }
            });
            break;        
        case "object_drivers":
        ...
        case "simcarddetails":
            var i = {
                cmd: "dashboard_load_sim_details"
            };
            $.ajax({
                type: "POST",
                url: "func/fn_settings.php",
                ...
                cache: !1,
                success: function(e) {
                    settingsSimCardDetails = e,initSelectList("setting_load_simcard"),t(!0)
                }
            });
            break;
        case "subaccounts":
...
function settingsObjectAdd(e) {
    if (utilsCheckPrivileges("subuser") && utilsCheckPrivileges("obj_add")) switch (e) {
        case "open":
             ...
             document.getElementById("dialog_settings_object_edit_board_imei").disabled = false,
    ...
    utilsCheckPrivileges("viewer") && utilsCheckPrivileges("subuser") && utilsCheckPrivileges("obj_edit") && confirmDialog(la.ARE_YOU_SURE_YOU_WANT_TO_DELETE, function(t) {
        if (t) {
            ...
            $.ajax({
                ...
                data: a,
                success: function(e) {
					"OK" == e && settingsReloadObjects(),$("#settings_main_events_event_list_grid").trigger("reloadGrid");
                }
            })
        }
    })
...
function settingsObjectEdit(e) {
    if (utilsCheckPrivileges("subuser") && utilsCheckPrivileges("obj_edit")) switch (e) {
        ...
        document.getElementById("dialog_settings_object_edit_sim_number").value = settingsObjectData[t].sim_number+'/'+settingsObjectData[t].sim_provider,
        document.getElementById("dialog_settings_object_edit_new_sim_number").value='',
        document.getElementById("dialog_settings_object_edit_board_imei").value=settingsObjectData[t].board_id,
        ...
        settingsEditData.board_id = settingsObjectData[t].board_id;
    	...
    	document.getElementById("dialog_settings_object_edit_board_imei").disabled = true,
    	addedit="edit",
    	changefueltype();
        ...
        case "save":
            ...
            var d = document.getElementById("dialog_settings_object_edit_map_icon").value,
                ...
                nm = document.getElementById("dialog_settings_object_edit_new_sim_number").value,
            ...
            if(addedit!="edit")
        	{
        		...
        		nt=document.getElementById("dialog_settings_object_edit_board_imei").value;	
        	}
            if(settingsUserData.cpanel_privileges=="super_admin" || settingsUserData.cpanel_privileges=="admin" || settingsUserData.obj_add=="true" )
            {
                if (t=="")
                {
    ...
    switch (e) {
        ...
        case "save":
            ...
            var I = {
                ...
                cache: !1,
                success: function(e) {
                    "OK" == e && (settingsReloadObjects(), $("#dialog_settings_object_service_properties").dialog("close"), $("#settings_object_service_list_grid").trigger("reloadGrid"),$("#dashboard_service_list_grid").trigger("reloadGrid"), notifyBox("info", la.INFORMATION, la.CHANGES_SAVED_SUCCESSFULLY))
                }
            })
    }
}
        ...
        confirmDialog(la.ARE_YOU_SURE_YOU_WANT_TO_DELETE, function(a) {
            if (a) {
                ...
                $.ajax({
                    ...
                    data: o,
                    success: function(e) {
                        "OK" == e && (settingsReloadObjects(), $("#settings_object_service_list_grid").trigger("reloadGrid"),$("#dashboard_service_list_grid").trigger("reloadGrid"))
                    }
                })
            }
        })
                                    ...
                                    loadSettings("events", function() {
                                        loadSettings("templates", function() {
                                            loadSettings("subaccounts", function() {
                                                loadSettings("simcarddetails", function() {
                                                    load2()
                                                })
                                            })
                                        })
...
function MapOnlineOfflineObject(v) {
    var e = $("#side_panel_objects_object_list_grid");
    e.clearGridData(!0);
    for (var t in settingsObjectData) {
        var a = settingsObjectData[t];
        if(settingsObjectData[t].status ==v){
            if ("true" == a.active) {
                var o = a.name.toLowerCase() + t.toLowerCase(),
                    i = a.name.toLowerCase(),
                    s = '<input id="object_visible_' + t + '" onClick="objectVisibleTrigger(\'' + t + '\');" class="checkbox" type="checkbox"/>',
...
function objectAddToMap(e) {
    ...
    u.bindTooltip(p, {
        ...
        // objectSelect(e), "" != objectsData[e].data && geocoderGetAddress(a, o, function(_) {
            ...
            if(settingsObjectData[e].driver_id!='' && settingsObjectData[e].driver_id!=0){
                var did=settingsObjectData[e].driver_id;
                if(did in settingsObjectDriverData){
                    j+="<tr><td><strong>" + la.DRIVER + ":</strong></td><td>" + settingsObjectDriverData[did].name+ "<br>"+settingsObjectDriverData[did].phone+"</td></tr>";
                }
            }
            // settingsObjectDriverData
            var k = j + m + u + p;
...
function dashboardloadGroup(){
    var t = document.getElementById("dashboard_object_group_list");
    t.options.add(new Option("Select",''));
    t.options.add(new Option(la.UNGROUPED, 0))
    for (var r in settingsObjectGroupData) {
        var c = settingsObjectGroupData[r];
        c.name != la.UNGROUPED && t.options.add(new Option(c.name, r))
    }
...
reportsData.reports = new Array, reportsData.edit_report_id = !1, reportsData.data_items = new Array, reportsData.event_list = new Array, reportsData.data_items.general = ["route_start", "route_end", "route_length", "move_duration", "stop_duration", "stop_count", "top_speed", "avg_speed", "overspeed_count", //"fuel_consumption", "fuel_cost", 
                                                                                                                                        ...
                                                                                                                                        //"trailer"
], reportsData.data_items.general_merged = ["route_start", "route_end", "route_length", "move_duration", "stop_duration", "stop_count", "top_speed", "avg_speed", "overspeed_count", 
                                                                                                                                                                                    //"fuel_consumption", "fuel_cost", 
                                                                                                                                                                                    "engine_work", "engine_idle", "odometer", "engine_hours", "driver", //"trailer",
                                                                                                                                                                                    "total"],
   reportsData.data_items.daily_km = ["route_start", "route_end", "route_length", "move_duration", "stop_duration", "stop_count", "top_speed", "avg_speed", "overspeed_count", //"fuel_consumption", "fuel_cost", 
                                                                                                                                                                                    "engine_work", "engine_idle", "odometer", "engine_hours", "driver", //"trailer",
                                                                                                                                                                                    "total"],
   reportsData.data_items.object_info = ["imei", "transport_model", "vin", "plate_number", "odometer", "engine_hours", "driver", "trailer", "gps_device", "sim_card_number","group_name","fueltype","fuel1","fuel2","temp1","temp2"],
   ...
   reportsData.data_items.drives_stops = ["status", "start", "end", "duration", "move_duration", "stop_duration", "route_length", "top_speed", "avg_speed",
                                                                                                                                                            //"fuel_consumption", "fuel_cost", 
                                                                                                                                                            "engine_work", "engine_idle"], 
   reportsData.data_items.travel_sheet = ["time_a", "position_a", "time_b", "position_b", "duration", "length", 
                                                                                                              //"fuel_consumption", "fuel_cost", 
                                                                                                              "total"], 
   ...
   reportsData.data_items.zone_in_out = ["zone_in", "zone_out", "duration", "zone_name", "zone_position"], 
   reportsData.data_items.events = ["object","time", "event", "event_position", "total"], 
...
reportsData.data_items.maintenancereport = ["CLIENT_ID","STAFFID","SITE_LOCATION","SCHEDULE","OBJECT","IMEI","WORK","IN_TIME","OUT_TIME","UNDER_WARRENTY","NOTE","TYPES_WORK"],
...
reportsData.data_items.oflinefuel=["OBJECT","GROUP","STARTING_FUEL","ENDING_FUEL","FUEL_CONSUMPTION","FUEL_FILLINGS","FUEL_THEFTS","ODOMETER","ODOMETER","TAKENKM","KMPL","MOVE_DURATION","STOP_DURATION","ENGINE_IDLE","STARTING_POINT","END_POINT"],
reportsData.event_list.events=["sos","SOS"
                                    // ,"bracon","BRACELET_ON","bracoff","BRACELET_OFF","mandown","MAN_DOWN","shock","SHOCK","tow","TOW","jamming","SIGNAL_JAMMING","lowdc","LOW_DC","connyes","CONNECTION_YES","connno","CONNECTION_NO","gpsyes","GPS_YES","gpsno","GPS_NO","underspeed","UNDERSPEED","dtc","DIAGNOSTIC_TROUBLE_CODES","temp_abn","TEMP_ABN","gpssta","GPSSTA","mainpwrsta","MAINPWRSTA","lowpwr","LOWPWR","dooropen","DOOROPEN","crash","CRASH","Shake","SHAKE"
                                    ,"pwrcut","POWER_CUT","gpsantcut","GPS_ANTENNA_CUT","lowbat","LOW_BATTERY","stopped","STOPPED","moving","MOVING","engidle","ENGINE_IDLE","overspeed","OVERSPEED","haccel","HARSH_ACCELERATION","hbrake","HARSH_BRAKING","hcorn","HARSH_CORNERING","param","PARAMETER","sensor","SENSOR","service","SERVICE","route_in","ROUTE_IN","route_out","ROUTE_OUT","zone_in","ZONE_IN","zone_out","ZONE_OUT","fuelstolen","FUELSTOLEN","lowfuel","LOWFUEL","fueldiscnt","FUELDISCNT","stopovrtime","STOPOVRTIME","aconidle","ACONENGIDLE"];
...
var settingsEditData = new Array,
    ...
    settingsSimCardDetails = new Array;
