...
{
    groupid='';
    if(utilsCheckPrivileges("live_tripreport")){
...
function hotspotin(savecancel)
{
	...
	if(hotspotsavename=="")
	 ...
	 var dat = {cmd: "save_hotspot",hotspot_code: vboarding.hotspotcode,hotspot_name: hotspotsavename,zonedetail:vt10data,freezekm:hotspotfreezekm };
		$.ajax({
                type: "POST",
                url: "func/fn_boarding.php",
                data: dat,
