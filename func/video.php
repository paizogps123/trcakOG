...
<head>
    ...
    <script type="text/javascript">
        ...
        function FtpRequestStatus(){
            var number = $("#selnumber  option:selected").text();
            window.open('https://cam.paizogps.in/808gps/open/player/ftp.html?jsession='+jsion+'&vehiIdno='+number, '_blank');
...
<!-- <option value='0'>Please select</option> -->
                ...
                <a id="ftpRequest" class="button button-primary button-rounded button-small settings"
                   ...
                   <a id="ftpRequest" class="button button-primary button-rounded button-small settings"
                   onclick="FtpRequestStatus()">Request Video Status</a> 
            </div>
        </div>
    </div>
