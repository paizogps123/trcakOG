<?
	...
	// if(@$_POST['imei']=='90001366')
	// {
	// 	$myfile = fopen("0t09.txt", "a");
	...
	*/
	...
	else if(@$_POST['method'] == 'Loc' || @$_POST['method'] == 'Locp'|| @$_POST['method'] == 'Loc1')
	{
		...
		if(@$_POST['rfid']!="")
		{
			...
			$loc['rfid'] = $_POST['rfid'];	
			// if($_POST['imei']=='99900147' || $_POST['imei']=='99900148'){
			// 	$myfile = fopen("vvv_foxcon_rfiddata_date issue.txt", "a");
			...
			// }					
			echo "DATAOK";
			check_events($loc, true, true, false,true);
			new_rfidswipe();
			die;			
		}
		...
		$params["voltage"]=@$_POST['voltage'];
		$params["adc"]=@$_POST['adc'];
