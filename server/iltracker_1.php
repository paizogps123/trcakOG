<?
	...
	if($_POST["method"]=="Cmd" && @$_POST['Response']!="")
	{
		...
		$q = "update command set status='Finished',response='".trim($_POST['Response'])."' where imei='".$_POST['imei']."' and response like '%Send%' and status='Waiting' ";
