<?
	...
	*/
	...
	if(@$_POST['imei']=='862207638000007'){
		$myfile = fopen("vvv_862207638000007.txt", "a");
		fwrite($myfile,json_encode($_POST));
		fwrite($myfile, "\n");
		fclose($myfile);
	}

	if(@$_POST['method'] == 'helthpocket')
	{
		...
		// {
		// 	$q = "UPDATE gs_objects SET `dt_server`='".$loc['dt_server']."'	WHERE imei='".$loc['imei']."'";
		// 	mysqli_query($ms,$q);
		// }
		insert_db_noloc($loc);
		echo 'HELTHOK';
	}
	if(@$_POST['method'] == 'Insert_Hamgwo_LT03')
	{
		$loc['protocol'] = @$_POST['protocol'];
		$loc['net_protocol'] = "";
		$loc['ip'] = @$_SERVER['REMOTE_ADDR'];
		...
		*/
		...
		$loc['params'] ="bi1=".@$_POST['bi1']."|bi2=".@$_POST['bi2']."|bi3=".@$_POST['bi3']."|bi4=".@$_POST['bi4']."|objectspeed=".@$_POST['objectspeed']."|gsm=".@$_POST['gsm']."|gps=".@$_POST['gps']."|blindarea=".@$_POST['blindarea']."|sleepmode=".@$_POST['sleepmode']."|removalalarm=".@$_POST['removalalarm']."|RTC_error=".@$_POST['RTC_error']."|trackmode=".@$_POST['trackmode']."|Gsensor_error=".@$_POST['Gsensor_error']."|light_sensor=".@$_POST['light_sensor']."|s1_rs1=".@$_POST['s1_rs1']."|restart_status=".@$_POST['restart_status']."|s2_rs1=".@$_POST['s2_rs1']."|s2_rs2=".@$_POST['s2_rs2']."|communication_interrupted=".@$_POST['communication_interrupted']."|s3_rs1=".@$_POST['s3_rs1']."|s3_rs2=".@$_POST['s3_rs2']."|WIFI_module_error=".@$_POST['WIFI_module_error']."|battery=".@$_POST['battery']."|s4_rs1=".@$_POST['s4_rs1']."|s4_rs2=".@$_POST['s4_rs2']."|s4_rs3=".@$_POST['s4_rs3']."|s4_di1=".@$_POST['s4_di1']."|acc=".@$_POST['acc']."|datatype=".@$_POST['datatype']."|";
		$loc['params'] = paramsToArray($loc['params']);
		
		$_POST['signal_gps']=@$_POST['gps'];

		if(@$_POST['signal_gps']!=null && @$_POST['signal_gps']>0)
		{
		...
		{
		$loc['imei'] = "22732012";
		$loc['lat'] = "13.0451".gmdate("is");
		$loc['lng'] = "80.180191".gmdate("is");
	...
	if(@$_POST['method'] == 'amwellInsert')
	{
		...
		*/
		...
		$loc['alarm'] = @$_POST['alarm'];
		//$loc['params'] = $_POST['params'];
		$loc['params'] =@$_POST['params']."gpsL=".@$_POST['signal_gps']."|"."acc=".@$_POST['acc']."|"."charge=".@$_POST['charge']."|";
		$loc['params'] = paramsToArray($loc['params']);
