<?
	...
	// if(@$_POST['imei']=='861359036784385'){
	// 	$myfile = fopen("lumactracker_.txt", "a");
	// 	fwrite($myfile,json_encode($_POST) );
	// 	fwrite($myfile, "\n");
	// 	fclose($myfile);
	// }

	if(@$_POST['method'] == 'processcmd')
	{
		// $myfile = fopen("lumactracker_CMD.txt", "a");
		// fwrite($myfile,json_encode($_POST));
		// fwrite($myfile, "\n");
		// fclose($myfile);
		echo "CMDOK";
	...
	if(@$_POST['method'] == 'lumaxlInsertNew')
	{
		...
		*/
		// if($loc['imei']=='861359036845525'){
		// 	$myfile = fopen("861359036845525_databackup.txt", "a");
		// 	fwrite($myfile,json_encode($_POST));
		// 	fwrite($myfile, "\n");
		// 	fclose($myfile);
		// 	echo "DATAOK";
