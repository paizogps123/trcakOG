<?php
	...
	sendEmail1("vetri42@gmail.com", "Test Message", "Test msg by IT Team", $no_reply = false, $att_name = false, $att_str = false);
	...
	function sendEmailv($email, $subject, $message, $no_reply = false, $att_name = false, $att_str = false)
	{
		require_once 'PHPMailerAutoload.php';
	
		$gsValues['EMAIL_SIGNATURE']="Playgps  .";
		$signature = "\r\n\r\n".$gsValues['EMAIL_SIGNATURE'];
		$message .= $signature;
		$message = str_replace("\\n", "\n", $message); 
...
//			$mail->Password   = $gsValues['EMAIL_SMTP_PASSWORD'];
			...
			//$mail->SMTPAuth   = "true";
			//$mail->SMTPSecure = "";
			//$mail->Username   = "support@playgps.in";
			//$mail->Password   = "AdminPlaygps098)(*";
			
			
		}
		
		$email_from ="reports@playgps.in";
